...
#tidying names
colNames=str_replace(colNames,"Acc","Accelerometer")
colNames=str_replace(colNames,"Gyro","Gyroscope")
colNames=str_replace(colNames,"BodyBody","Body")
colNames=str_replace(colNames,"Mag","Magnitude")
colNames=str_replace(colNames,"^t","Time")
colNames=str_replace(colNames,"^f","Frequency")
colNames=str_replace(colNames,"freq","Frequency")
colNames=str_replace(colNames,"angle","Angle")
colNames=str_replace(colNames,"gravity","Accelerometer")
colNames=str_replace(colNames,"Acc","Gravity")
colNames=str_replace(colNames,"Acc","Accelerometer")
colNames=str_replace(colNames,"Acc","Accelerometer")
...
write.table(data_long,"./tidy_data.txt", row.name=FALSE)
